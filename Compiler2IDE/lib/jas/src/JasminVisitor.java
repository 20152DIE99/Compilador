 ...
 * @version $Id: JasminVisitor.java,v 1.12 2001/10/04 13:22:54 dahm Exp $
 */
public class JasminVisitor extends de.fub.bytecode.classfile.EmptyVisitor {
	...
	public void visitJavaClass(JavaClass clazz)
	{
		...
		out.print("\n");
		System.out.println("end of JasminVisitor.visitJavaClass");
	}
	...
	public void visitSynthetic(Synthetic attribute)
	{
		...
		if (method != null) printEndMethod(attribute); //for method output
		else out.println(""); //for class field output
	}
	...
	public void visitCode(Code code)
	{
		...
		for (int i = 0; i < ehs.length; i++) {
			...
			String class_name = (caught == null) ?  // catch any exception, used when compiling finally
					"java/lang/Exception" : caught.getClassName().replace('.', '/');
